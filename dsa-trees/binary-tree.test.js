...
//   it("returns node depth", function () {
//     let newSmallTree;
//     let newLargeTree;

//     let smallLeft = new BinaryTreeNode(5);
//     let smallRight = new BinaryTreeNode(7);
//     let smallRoot = new BinaryTreeNode(6, smallLeft, smallRight);
//     newSmallTree = new BinaryTree(smallRoot);
...
//     let node1 = new BinaryTreeNode(5);
//     let root = new BinaryTreeNode(6, node1, node2);
//     newLargeTree = new BinaryTree(root);

//     expect(newSmallTree.findDepth(smallRoot)).toBe(1);
//     expect(newSmallTree.findDepth(smallLeft)).toBe(2);
//     expect(newSmallTree.findDepth(smallRight)).toBe(2);
//     // expect(newLargeTree.findDepth(node1)).toBe(2);
//     // expect(newLargeTree.findDepth(node4)).toBe(4);
//   });
// });
